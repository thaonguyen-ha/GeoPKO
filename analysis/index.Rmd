...
```
## Overview of the included missions

The following table aims to provide users with an overview of the missions that are included in the dataset and what years of the mission the dataset covers.
```{r}
